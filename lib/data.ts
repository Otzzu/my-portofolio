...
export const projects: Project[] = [
  ...
  {
    title: "Inventory KopI Piknik",
    description:
      "Inventory Kopi Piknik is a Next.js 14 dashboard built to centralize the operations of Kopi Piknik café. Each menu item is linked with its ingredients and costs, enabling the system to track usage and compare sales revenue with purchase expenses. The platform provides a product workspace for managing new menu items, browsing categories of drinks, foods, and desserts, and includes inventory tools such as quick registration forms, search, stock in, stock opname, and threshold reminders to keep supplies accurate. \nOn the financial side, sales records can be filtered by date range, summarized, and enriched with ingredient breakdowns to align recipes with revenue. A dedicated analytics section visualizes KPIs, sales trends, and COGS insights for data-driven decisions, while role-based member management and comprehensive audit logs ensure collaboration and accountability across the team.",
    tags: [
      "TypeScript",
      "React",
      "Next.js",
    ...
    image: "/assets/img/piknik.webp",
    href: "https://github.com/Otzzu/inventory-kopi-piknik",
    context: "University Project",
  },
  {
    title: "Purrytify",
